...
!       real(8), intent(out) :: norm
      ...
      subroutine compute_dyn_observables(nch, nmax,                 &
                                        xx, wx, jac,               &
                                        eigval, eigvec,            &
                                        norm,                  &
                                        p0, pexc, pion,            &
        ...
        ! --- norm ---
        norm(1) = sum(abs(psi_x)**2 * (wx**2) * jac)
...
!       real(8), parameter :: ppi = 3.141592653589793d0
        ...
        call eigen_to_dvr(nmax, 1, jacc, wx, eigvec, psi, psic)
...
!       call eigen_to_dvr(nmax, 1, jacc, wx, eigvec, wf_1, wfc_1)
!       call eigen_to_dvr(nmax, 1, jacc, wx, eigvec, wf_2, wfc_2)
        ...
        call apply_momentum_operator(nmax, eigvec, xx, wx,        &
                          jacc, wf0_1, auxc, 0)
        call eigen_to_dvr(nmax, 1, jacc, wx, eigvec, auxc, pwfc_0)
     
        call eigen_to_dvr(nmax, 1, jacc, wx, eigvec, wf0_1, wfc0_1)
